...
def get_parser():
    ...
    parser.add_argument('--total_epoch', default=200, type=int, help='Total number of training epochs')#200
    parser.add_argument('--decay_epoch', default=150, type=int, help='Number of epochs to decay learning rate')#150
    parser.add_argument('--model', default='resnet', type=str, help='model',
                        choices=[ 'resnet','densenet', 'vgg'])#
    parser.add_argument('--optim', default='adabelief', type=str, help='optimizer',
                        choices=['sgd', 'adam',  'adabelief', 'adamw','yogi', 'msvag', 'radam', 'fromage', 'adabound',
                                 ])
